...
Movie.create([
  {title: "Star Wars", rating: "PG", description: "Star Wars is an American epic space opera franchise, created by George Lucas and centered around a film series that began with the eponymous 1977 movie. The saga quickly became a worldwide pop culture phenomenon.", release_date: "1979-05-25 00:00:00"},
